  ...
  return (
    <div className='content_box'>
      <div className='category_desc'>
        ...
        <div>
          <p>
            하나의 제품이 만들어지기 위해 필요한 모든 소재와 제조과정을 파악하여
            100% 투명성에 도달할 수 있도록 지속가능성을 실천합니다.
          </p>
        </div>
      </div>
      ...
      <div className='category_desc'>
        ...
        <div>
          <p>
            엄선하게 선별된 주요 소재와 제품에 사용되는 작은 부품까지 해당되는
            모든 소재에 대한 정보를 공유합니다.
          </p>
        </div>
      </div>
      <div className='test item' ref={topRef}>
        ...
        <div>
          <p>
            ...
            사이즈를 한국인 발에 맞춰 보완한 라스트입니다. 아몬드 형태의 앞코를
            가졌으며 발등과 발볼이 넓게 나왔습니다. 표준 사이즈로 발 뒤꿈치가
            들리지 않게 끈을 잘 조여주시면 편안하게 신을 수 있습니다.
          </p>
        </div>
      </div>
      <div className='category_desc'>
      ...
      <div className='test material' ref={matRef}>
        <div className='material_column_small'>
          <div>
            ...
            <div>
              <p>
                lwg(leather working group) gold medal 수상한 이탈리아산 풀그레인
                소가죽으로 나파가죽처럼 부드럽고 광택이 은은하게 있는 것이
                특징입니다.
              </p>
              <p>
                종류: 풀그레인 소가죽 풀카프 <br></br>태닝: 크롬 태닝 (이탈리아
                베네토 비첸자) <br></br>마감: 세미아날린 <br></br>
          ...
          <div>
            ...
            <div>
              <p>
                lwg 인증된 이탈리아산 발수(water repellent) 가능한 스웨이드로
                크러스트 원피를 하나씩 확인하며 정교하게 아날린 염색을 드럼통을
                돌려서 일정하게 유지되는 색상과 품질을 만들어냅니다. 따로 어떠한
                마감을 하지 않으며 자연스러운 가죽을 고집합니다.
              </p>
              <p>
                종류: 크러스트 소가죽 <br></br>태닝: 크롬 태닝 (이탈리아 피사
                산타 크로체)<br></br>마감: 없음<br></br> 원피: 프랑스와 네덜란드
                <br></br> 두께: 1.4mm-1.6mm
              </p>
            </div>
          </div>
          <div>
            ...
            <div>
              ...
              <p>
                종류: 풀그레인 소가죽<br></br> 태닝: 크롬 태닝 (이탈리아 마르케
                페르모)<br></br> 마감: 세미 아날린<br></br> 원피: 파키스탄
                <br></br> 두께: 0.8mm-1.0mm
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='manufacturing_intro'>
          <div>
            <p>
              ...
              프로파일 기계에 넣어 신발라스트와 형태를 맞춥니다. 아웃솔과 함께
              부착을 위한 안정화를 위하여 하루 더 건조시킨 후 다음날 아웃솔의
              윗면과 측면을 갈아냅니다. 마지막으로 검수를 진행 후 신발 공장으로
              보내집니다. <br></br>
              <br></br>핸드메이드 클래식 러닝 아웃솔(포르투갈 펠게이라 페네코바){' '}
              <br></br>스티렌부타디엔 고무로 아웃솔 제작<br></br> 두개 층의 eva
              생산하여 재단 및 접착 후 미드솔과 아웃솔을 조립
              <br></br>
              <br></br>
              [마지막 방문] 2020년 10월
            </p>
        ...
        <div className='sub_material_intro'>
          <div>
            <p>
              ...
              사용(포르투갈) 100% 폴리에스터를 방적하여 재봉실로 생산(이탈리아)
              수성 기반의 접착제로 사용(포르투갈) 재활용된 폴리에스테르로
              제작(포르투갈) 100% 유기농 코튼 방적하여 끈으로 생산(포르투갈)
              100% 사탕수수(콜롬비아)를 서울시 광진구에서 자연생분해가 되는
              종이로 재가공하여 제작 100% 유기농 코튼으로 봉제하여 코튼 레이스
              적용(포르투갈) 100% 재활용된 골판지와 카톤 종이로 제작(포르투갈)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className='category_desc'>
        ...
        <div>
          <p>하지 생체 역학기술을 바탕으로 편안한 걸음이 되도록 개발합니다.</p>
        </div>
      </div>
        ...
        <div className='technology_intro'>
          <div>
            <p>
              ...
              2015년 부터 독자적인 아웃솔과 인솔패드를 개발하여 제품에 적용하고
              있으며 지속적으로 새로운 기술개발을 합니다.
            </p>
          </div>
          <div>
      ...
      <div className='category_desc'>
        ...
        <div>
          <p>
            시멘팅(cementing)공법. 소재부터 최종 신발에 이르는 모든 제조단계를
            보여줍니다.
          </p>
        </div>
      </div>
        ...
        <div className='manufacturing_intro'>
          <div>
            <p>
              ...
              생산합니다. 주로 북유럽 브랜드들과 협업하며 영국, 이탈리아, 독일
              및 여러 유럽 국가에 수출합니다. 신발을 만들 때 가장 많이 소요되는
              부분인 재단, 재봉, 저부, 조립, 마감 및 포장을 직접 제조시절에
              방문하여 작업 환경을 확인하여 진행합니다.
            </p>
          </div>
          <div>
            {scrollPosition &&
